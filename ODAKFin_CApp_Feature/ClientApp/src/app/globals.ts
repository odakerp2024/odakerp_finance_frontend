...
export class Globals {
    ...
    // LANDINGURL: string = 'https://sa-navioindia.freighteiz.com/api'
...
// APIURL: string = 'https://la-navioindia.freighteiz.com/api';
//     APISAURL: string = 'https://sa-navioindia.freighteiz.com/api';
//     APIURLFF: string = 'https://sa-navioindia.freighteiz.com/ffddev/api';
//     APIFNURL: string = 'https://fn-navioindia.freighteiz.com/api'