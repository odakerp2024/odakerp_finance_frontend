...
@Component({
  selector: 'app-prealertmail',
  templateUrl: './prealertmail.component.html',
  styleUrls: ['./prealertmail.component.css']
})
export class PrealertmailComponent implements OnInit {
        ...
        this.route.queryParams.subscribe(params => {
            ...
            if (queryString["VesselID"] != 0) {
                ...
                this.vesselForm = this.fb.group({
                    ...
                    VoyageID: queryStringVy["VoyageID"],
    ...
    prealertMail() {
        ...
        this.vsl.getPrealertMailBind(this.vesselForm.value).subscribe(data => {
    ...
    btnEmailSend() {
        this.vesselForm.value.VesselID = this.VesselID;
        this.vesselForm.value.VoyageID = this.VoyageID;
        this.vsl.getEmailSend(this.vesselForm.value).subscribe(data => {
