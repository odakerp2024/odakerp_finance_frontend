...
import { ReportExportService } from 'src/app/services/financeModule/report-export.service';
...
export class ReportArLeveloneComponent implements OnInit {
  ...
  export(){
    if(this.type =="overall")
    {
      this.exportService.downloadAsExcel(this.reportList, this.startDate, this.endDate, 'overall');
    }
   else if(this.type =="customerwise")
    {
      this.exportService.downloadAsExcel(this.reportList, this.startDate, this.endDate, 'customerwise');
    }
  else
    {
      this.exportService.downloadAsExcel(this.reportList, this.startDate, this.endDate, 'customerinvoicewise');
    }
  } 
