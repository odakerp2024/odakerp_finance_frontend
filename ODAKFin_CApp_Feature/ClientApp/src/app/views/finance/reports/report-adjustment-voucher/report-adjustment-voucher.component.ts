...
@Component({
  selector: 'app-report-adjustment-voucher',
  templateUrl: './report-adjustment-voucher.component.html',
  styleUrls: ['./report-adjustment-voucher.component.css']
})


export class ReportAdjustmentVoucherComponent implements OnInit {
...
const columnsToColorRight = ['Voucher', 'Account', 'Amount', 'Amount (CCY)', 'Ex Rate'];
...
columnsToAlignRight.forEach(columnName => {
  ...
  if (columnIndex !== -1) {
    ...
    saveAs(blob, 'Report-AdjustmentVoucher.xlsx');
  }
