...
export class CustomerComponent implements OnInit {
  ...
  async updateBasicCustomerDetail() {
    debugger
    await this.autoCodeGeneration(true);
   ...
   async updateOfficeDetails() {
    ...
    debugger
    await this.updateBasicCustomerDetail();
    //  this.getBranchCodeAPI(this.Customer_Code);
...
debugger  
 ...
 async getNumberRange() {
  ...
  async getBranchCodeAPI(code: string) {
    debugger
    return new Promise(async (resolve, rejects) => {
