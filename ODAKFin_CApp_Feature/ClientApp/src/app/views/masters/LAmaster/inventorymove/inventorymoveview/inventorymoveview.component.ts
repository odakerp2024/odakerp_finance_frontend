...
@Component({
    selector: 'app-inventorymoveview',
    templateUrl: './inventorymoveview.component.html',
    styleUrls: ['./inventorymoveview.component.css']
})
export class InventorymoveviewComponent implements OnInit {
    title = 'Inventory Move Creation';
    ...
    MoveList() {
        ...
        this.IS.getMoveList(this.searchForm.value).subscribe(data => {
            this.allItems = data;
            this.setPage(1);
        });
    }
    ...
    onSubmit() {
        ...
        this.searchForm.value.StatusID = $('#ddlStatusv').val();
        this.IS.getMoveList(this.searchForm.value).subscribe(off => {
            this.allItems = off;
            this.setPage(1);
