...
@Component({
  selector: 'app-damagemasterview',
  templateUrl: './damagemasterview.component.html',
  styleUrls: ['./damagemasterview.component.css']
})
export class DamagemasterviewComponent implements OnInit {
    title = 'Damage Master';
    statusvalues: Status[] = [
    ...
    refreshDepList() {
        this.ms.getDamageList(this.searchForm.value).subscribe(data => {
