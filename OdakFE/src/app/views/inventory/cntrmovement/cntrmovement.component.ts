...
@Component({
  selector: 'app-cntrmovement',
  templateUrl: './cntrmovement.component.html',
  styleUrls: ['./cntrmovement.component.css']
})
export class CntrmovementComponent implements OnInit {
