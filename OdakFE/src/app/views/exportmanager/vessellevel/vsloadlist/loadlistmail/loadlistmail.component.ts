...
@Component({
  selector: 'app-loadlistmail',
  templateUrl: './loadlistmail.component.html',
  styleUrls: ['./loadlistmail.component.css']
})
export class LoadlistmailComponent implements OnInit {
